...
workflow fetchData {
    ...
    if (!params.skipDownloads) {
        ...
        if (params.useUrml || params.useArba) {
            ...
            downloadUrmlTemplates(urmlTemplatesUri, urmlTemplatesPath, "unirule-templates.xml")
        }
        ...
        if (params.useUrml) {
            ...
            downloadUrml(urmlUri, urmlPath, "unirule-urml.xml")
        }
        ...
        if (params.useArba) {
            ...
            downloadArba(urmlUri, urmlPath, "arba-urml.xml")
        }
